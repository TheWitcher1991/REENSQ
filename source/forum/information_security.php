<?php session_start();
Head('Форумы | Информационная безопасность');
?>
<body>
...
<section class="navig">
    ...
    <a href="/information_security" style="color: #7082a7;font-weight: bold">Информационная безопасность</a>
</section>
    ...
    <article class="wrapper">
        <section class="row-glab">
            <div class="categories">
                <div class="row-div" id="communication">
                    <div class="logos-row">
                        <div>
                            <img src="/static/img/section/security.png" alt="Информационная безопасность">
                            <h1>Информационная безопасность</h1>
                        </div>
                    </div>
                    <div class="categories-list">
                    <div class="row-list-section su-div">
                    <ul>
                            <!--<li>
                                <div class="name-for">
