...
<header id="header">
    <section class="header-section">
        <div class="nav-header dtheme">
            ...
            <right-navigator :aside="true"></right-navigator>
                    ...
                    <div class="right-bar-row">
                            <div class="p-popup-acount">
                                <div class="p-navgroup-popup">
                                    ...
                                    <i class="fas fa-toggle-off" id="sub_close"></i>
                                </div>
                                        ...
                                        while ($row = $stmtMsg->fetch()) {
                                            ...
                                            <li>
                                                <div class="header-msg-img">
                                                    <img style="width:100%;height:100%;border-radius:50%" src="/static/img/avatar/<?php echo $auh['avatar'] ?>" alt="avatar">
                                                </div>
                                                <div class="header-info-title">
                                                    <div class='header-msg-title'><a href='/account/message?whom=<?php echo $row['who'] ?>&act=<?php echo $row['id'] ?>'><?php echo $row['title'] ?></a></div><div class="header-info-title">
                                                    <div class="header-info-title">
