<!-- Footer -->
<footer id="footer" class="dtheme" style="margin-top: 40px">
    <section class="foot-div">
        <?php
    if (!isset($_SESSION['username']) && !isset($_SESSION['password'])) {
    ?>

        <!-- Создаем экземпляр компонента account -->
        <account-info :register="true"></account-info>
    <?php
    }
